...
export const zhTranslations: TranslationDict = {
  ...
  "common.autoTitleEnabledHint":
    "按当前规则自动生成，切换分类或状态时会自动更新。",
  ...
  // visitors
  "visitors.deleteUser": "删除用户",
  "visitors.deleteUserTitle": "删除访客？",
  "visitors.deleteUserDescription":
    "删除该访客会同时删除其评论、留言、附属回复树和订阅，且无法恢复。",
  "visitors.deleteUserSuccess": "访客已删除",
  "visitors.deleteUserFailed": "删除访客失败",
  ...
  "settings.oauthLoginConfigStep2": "如需开启邮箱，在同页绑定管理员邮箱即可。",
  ...
  "dashboard.assets": "资源",
  "dashboard.updateNewVersion": "新版本 {version}",
  "dashboard.updateChecking": "检查更新中",
  "dashboard.updateQueued": "检查更新中",
  "dashboard.updateRunning": "正在更新",
  "dashboard.updateSucceeded": "更新完成",
  "dashboard.updateFailed": "更新失败",
  "dashboard.updateRolledBack": "已回滚",
  "dashboard.updateDialogTitle": "系统更新",
  "dashboard.updateInterruptingTitle": "服务即将短暂中断",
  "dashboard.updateInterruptingLine1": "更新正在接管服务",
  "dashboard.updateInterruptingLine2": "相信我，放宽心喝口茶，我马上就会回来了。",
  "dashboard.updateCurrentVersion": "当前版本",
  "dashboard.updateTargetVersion": "目标版本",
  "dashboard.updateReleasedAt": "发布时间",
  "dashboard.updateChannel": "渠道",
  "dashboard.updateChannelStable": "稳定版",
  "dashboard.updateChannelDev": "开发版",
  "dashboard.updateSignatureTrusted": "更新元数据签名已验证",
  "dashboard.updateSignatureBlocked": "签名未通过，已禁止后台自动升级",
  "dashboard.updateNotes": "更新说明",
  "dashboard.updateRecentLog": "最近日志",
  "dashboard.updateNoNotes": "本版本没有提供更新说明。",
  "dashboard.updateAvailableHint": "",
  "dashboard.updatePreflightHint": "正在执行升级预检。",
  "dashboard.updateRunningHint": "服务正在更新，期间管理台可能短暂断开。",
  "dashboard.updateReconnectHint": "服务正在重启，管理台会自动等待恢复。",
  "dashboard.updateSucceededHint": "更新已完成，管理台即将刷新。",
  "dashboard.updateFailedHint": "升级没有完成，请查看最近日志。",
  "dashboard.updateRolledBackHint": "升级失败后已尝试回滚到旧版本。",
  "dashboard.updateCheck": "检查",
  "dashboard.updateStart": "更新",
  "dashboard.updateStarting": "正在提交",
  "dashboard.updateCheckQueued": "检查请求已提交",
  "dashboard.updateCheckFailed": "检查请求提交失败",
  "dashboard.updateUpgradeQueued": "升级请求已提交",
  "dashboard.updateUpgradeFailed": "升级请求提交失败",
  "dashboard.updateCancelQueued": "取消排队",
  "dashboard.updateCanceling": "正在取消",
  "dashboard.updateCancelQueuedDone": "已取消更新请求",
  "dashboard.updateCancelQueuedFailed": "取消更新请求失败",
  "dashboard.updateServiceRestarting": "服务正在重启",
  ...
  "contentCategories.description": "统一管理文章、手记和文摘的分类。",
  ...
  "contentCategories.notePlaceholder": "选择手记分类",
  ...
  "friends.moreConfigMissing": "还没有找到友链页配置，请先初始化页面文案配置。",
  ...
  "moderation.markRead": "标记已读",
  "moderation.markReadSuccess": "已标记为已读",
  "moderation.unread": "未读",
  "moderation.attentionUnread": "{count} 条未读",
  "moderation.attentionPending": "{count} 条待审",
  ...
  "moderation.diaryAccessRequestedAt": "申请时间",
  "moderation.diaryAccessPermissionStatus": "是否有权限",
  "moderation.diaryAccessPending": "待处理",
  "moderation.diaryAccessUnauthorized": "无权",
  "moderation.diaryAccessAuthorized": "有权",
  "moderation.diaryAccessAuthorizedTotal": "已授权",
  "moderation.diaryAccessReason": "申请理由",
  "moderation.diaryAccessGrant": "赋予权限",
  "moderation.diaryAccessGrantDescription": "开启后按下方到期时间授予或延长权限。",
  "moderation.diaryAccessExpiresAt": "权限到期时间",
  "moderation.diaryAccessGrantNow": "授予权限",
  "moderation.diaryAccessExtend": "延长权限",
  "moderation.diaryAccessRevokeNow": "立即停止权限",
  "moderation.diaryAccessIgnore": "不予理睬",
  "moderation.diaryAccessStatus": "申请状态",
  "moderation.diaryAccessGrantedAt": "授权时间",
  "moderation.diaryAccessRevokedAt": "停止时间",
  "moderation.diaryAccessRemainingDays": "剩余 {days} 天 {hours} 小时",
  "moderation.diaryAccessRemainingHours": "剩余 {hours} 小时 {minutes} 分钟",
  "moderation.diaryAccessRemainingMinutes": "剩余 {minutes} 分钟",
  "moderation.diaryAccessFeedbackTemplateAction": "修改反馈信息的格式",
  "moderation.diaryAccessFeedbackTemplateTitle": "审核后反馈给访客的邮件格式",
  "moderation.diaryAccessFeedbackTemplateDescription":
    "",
  "moderation.diaryAccessFeedbackTemplateField": "邮件正文",
  "moderation.diaryAccessFeedbackTemplateDefault": "默认格式",
  "moderation.diaryAccessFeedbackTemplatePlaceholders":
    "可用占位符：{placeholders}",
  "moderation.diaryAccessFeedbackTemplateRestoreDefault": "恢复默认",
  "moderation.diaryAccessFeedbackTemplateVariablesHelpLabel": "可用占位符说明",
  "moderation.diaryAccessFeedbackTemplateVariables": "日记查看申请反馈模板占位符说明",
  "moderation.diaryAccessFeedbackTemplateVariablesDescription":
    "在日记查看申请反馈邮件正文中可使用以下占位符，发送时系统会自动替换为对应内容。",
  "moderation.diaryAccessFeedbackTemplateVariablesUsage": "占位符列表",
  "moderation.diaryAccessFeedbackTemplatePlaceholderSiteName": "{site_name}：站点名称",
  "moderation.diaryAccessFeedbackTemplatePlaceholderSiteUrl": "{site_url}：站点地址",
  "moderation.diaryAccessFeedbackTemplatePlaceholderVisitorName": "{visitor_name}：申请访客名称",
  "moderation.diaryAccessFeedbackTemplatePlaceholderVisitorEmail": "{visitor_email}：申请访客邮箱",
  "moderation.diaryAccessFeedbackTemplatePlaceholderDecision": "{decision}：审核结果",
  "moderation.diaryAccessFeedbackTemplatePlaceholderExpiresAt": "{expires_at}：权限到期时间；未授予或已停止时显示“未授予权限”",
  "moderation.diaryAccessFeedbackTemplatePlaceholderReason": "{reason}：申请理由",
  "moderation.diaryAccessFeedbackTemplatePlaceholderRequestedAt": "{requested_at}：申请时间",
  "moderation.diaryAccessFeedbackTemplatePlaceholderReviewedAt": "{reviewed_at}：审核时间",
  "moderation.diaryAccessFeedbackTemplateConfirm": "确认修改",
  ...
  "assets.scopeArticle": "文章资源",
  "assets.scopeVisitor": "访客资源",
  "assets.scopeSystem": "系统资源",
  "assets.scopeOssSync": "OSS 同步记录",
  "assets.scopeServiceForward": "服务转发",
  ...
  "assets.syncTypeLocalDelete": "本地删除",
  ...
  "assets.syncRetry": "重试",
  "assets.syncRetryQueued": "已加入重试队列",
  "assets.syncRetryFailed": "无法加入重试队列",
  "assets.syncLastError": "最近错误",
  "assets.links": "链接",
  ...
  // service forwards
  "serviceForwards.add": "新增",
  "serviceForwards.addTitle": "新增服务转发",
  "serviceForwards.pageDescription": "通过当前域名访问本机或 Tailscale 网络内的服务",
  "serviceForwards.editTitle": "编辑服务转发",
  "serviceForwards.name": "服务备注名",
  "serviceForwards.namePlaceholder": "例如：家中面板",
  "serviceForwards.slug": "slug",
  "serviceForwards.publicPath": "访问路径",
  "serviceForwards.target": "转发目标",
  "serviceForwards.source": "来源",
  "serviceForwards.source.local": "当前机器",
  "serviceForwards.source.tailscale": "Tailscale",
  "serviceForwards.source.custom": "命令行规则",
  "serviceForwards.port": "端口",
  "serviceForwards.targetUrl": "Tailscale 服务网址",
  "serviceForwards.targetUrlPlaceholder": "https://设备名.tailnet.ts.net/服务路径",
  "serviceForwards.status": "状态",
  "serviceForwards.reachable": "可访问",
  "serviceForwards.unreachable": "不可访问",
  "serviceForwards.unchecked": "未检测",
  "serviceForwards.open": "打开服务",
  "serviceForwards.test": "检测连通性",
  "serviceForwards.customEditHint": "命令行创建的规则请继续使用 sercli 修改",
  "serviceForwards.create": "创建",
  "serviceForwards.created": "服务转发已创建",
  "serviceForwards.updated": "服务转发已更新",
  "serviceForwards.deleted": "服务转发已删除",
  "serviceForwards.testReachable": "服务可以访问",
  "serviceForwards.testUnreachable": "服务暂时无法访问",
  "serviceForwards.testFailed": "连通性检测失败",
  "serviceForwards.loadFailed": "无法加载服务转发，请检查服务状态后重试。",
  "serviceForwards.reload": "重新加载",
  "serviceForwards.requiredFields": "请填写服务备注名和 slug",
  "serviceForwards.invalidPort": "端口必须在 1 到 65535 之间",
  "serviceForwards.invalidTargetUrl": "请输入完整的 Tailscale HTTP 或 HTTPS 服务网址",
  "serviceForwards.deleteTitle": "删除服务转发？",
  "serviceForwards.deleteDescription": "删除“{name}”后，对应的公开路径会立即停止转发。",
  "serviceForwards.confirmDelete": "确认删除",
  ...
  "system.exportRecoveryKey": "设置恢复密码",
  "system.rotateRecoveryKey": "更换恢复钥匙",
  "system.rotateRecoveryKeyDescription":
    "会生成新的恢复钥匙用于之后的新备份。系统会保留历史钥匙，旧备份仍然可以恢复。",
  "system.exportRecoveryKeyDescription":
    "请输入恢复密码，系统会用它保护恢复钥匙包。普通流程不会显示底层钥匙内容。",
  "system.recoveryKeyPassword": "恢复密码",
  "system.recoveryKeyPasswordDescription":
    "这个密码用于保护备份恢复钥匙包。以后如果 Serino 主机坏了，只要备份机还在，就需要这个密码恢复数据。",
  "system.recoveryKeyOneTimeWarning":
    "恢复密码设置后请妥善保存。忘记密码后，旧备份无法解密恢复。",
  "system.recoveryKeyPrivatePem": "恢复钥匙",
  "system.recoveryKeyPrivatePemDescription":
    "这是底层恢复钥匙内容，仅用于兼容旧工具；普通备份流程不会展示它。",
  "system.copyRecoveryKey": "复制恢复钥匙",
  "system.downloadRecoveryKey": "下载恢复钥匙",
  "system.recoveryKeyCopied": "已复制恢复钥匙",
  ...
  "system.backupProbeSuccess": "备份机检测完成",
  "system.backupProbeFailed": "备份机暂未连接",
  "system.backupProbeNeedsBootstrap": "请生成临时命令，并在备份机终端上执行",
  "system.backupConnectionStatus": "连接状态",
  "system.backupConnectionNotConfigured": "未接入",
  ...
  "system.recoveryKeyMustBeCopiedBeforeSave":
    "请先确认恢复密码，然后再继续保存备份配置。",
  "system.prepareLocalKeys": "准备本机密钥",
  "system.saveAndRunFirstBackup": "保存并创建首次备份",
  "system.testAndStartBackup": "测试并开始备份",
  "system.testAndSave": "测试并保存",
  "system.backupConfigSaved": "备份配置已保存",
  "system.startBackupAction": "启动备份",
  "system.detectBackupMachine": "检测",
  "system.firstBackupStarted": "已保存配置并触发首次备份",
  "system.backupBootstrapStepHost": "第一步",
  "system.backupBootstrapStepCommand": "第二步",
  "system.backupBootstrapStepStart": "第三步",
  "system.backupBootstrapHostTitle": "填写备份机 ip / 主机名 (tailscale)",
  "system.backupBootstrapCommandTitle": "在备份机执行命令",
  "system.backupBootstrapConnected": "已连接",
  "system.backupBootstrapAwaiting": "等待备份机执行命令",
  "system.backupMachineAddress": "备份机地址",
  "system.backupMachineFixedDefaults":
    "只需要填写地址。系统会固定使用 serino-backup 用户和 /srv/serino-backups 目录。",
  "system.backupDetectTitle": "连接备份机",
  "system.backupDetectDescription": "连接备份机。",
  "system.backupBootstrapGenerate": "生成临时命令",
  "system.backupBootstrapRegenerate": "重新生成",
  "system.backupBootstrapRevoke": "撤销命令",
  ...
  "system.backupBootstrapStatusPending":
    "在备份机的终端执行，然后进行第三步设置恢复密码",
  "system.backupBootstrapStatusSucceeded": "脚本已成功执行",
  "system.backupBootstrapStatusFailed": "脚本执行失败",
  "system.backupBootstrapStatusExpired": "临时命令已过期",
  "system.backupBootstrapStatusRevoked": "临时命令已撤销",
  ...
  "system.forgotRecoveryPasswordDescription":
    "恢复密码无法找回。请在备份机的 sudo 用户下执行下面命令清空远端备份和备份用户，然后回到高级选项重置本机备份系统。",
  "system.backupCleanupCommandCopied": "清理命令已复制",
  "system.startBackupTitle": "开始备份",
  "system.startBackupDescription":
    "检测安全且恢复密码已设置后，就可以开始首次备份。",
  "system.startBackupAfterDetection":
    "请先完成检测，并处理可能存在的远端历史冲突。",
  ...
  "system.runtimeEncryptionLabelEnabled": "加密数据库与媒体备份已开启",
  "system.runtimeEncryptionLabelDisabled": "加密数据库与媒体备份未开启",
  ...
  "integrations.mcpUsageGuides": "使用说明",
  "integrations.mcpRestGuideTitle": "REST API 接入",
  "integrations.mcpRestDialogDescription": "手动连接远程 MCP 的最短流程。",
  "integrations.mcpRestStepCreateKeyTitle": "创建并保存 API Key",
  "integrations.mcpRestStepCreateKeyDescription":
    "在 MCP 权限配置中勾选 Agent 需要的权限，创建后保存完整密钥串。",
  "integrations.mcpRestStepAgentTitle": "把 Key 交给 Agent，让它去了解",
  "integrations.mcpRestStepAgentPrefix": "将密钥串发给 Agent，并让它访问",
  "integrations.mcpRestStepAgentSuffix": "读取使用说明与可用能力。",
  "integrations.mcpRestStepReadyTitle": "开始管理网站",
  "integrations.mcpRestStepReadyDescription":
    "读取完成后，Agent 会按这把 Key 的权限工作。接下来直接告诉它你想完成什么。",
  "integrations.mcpClientGuideTitle": "Codex / Claude Code 接入",
  "integrations.mcpClientDialogDescription": "安装 MCP 与 Skills，并管理 API Key。",
  "integrations.mcpClientStepInstall": "运行安装命令",
  "integrations.mcpClientStepCredential": "按照提示输入 Serino MCP API Key",
  ...
  "integrations.mcpUpdateKey": "以后更换 MCP API Key",
  "integrations.mcpUpdateKeyDescription":
    "运行以下命令输入新 Key；Codex 会自动重连。",
  "integrations.mcpCopyKeyCommand": "复制更新 Key 命令",
  "integrations.mcpInstallCopyCommand": "复制 {client} 安装命令",
  "integrations.mcpInstallCommandCopied": "已复制 {client} 命令",
  "integrations.mcpInstallCopyFailed": "复制失败，请手动选择命令复制",
  ...
  "automation.deadLettersDescription": "查看超过重试上限的投递，并在目标恢复后手动重放。",
  ...
  "dashboard.unreadModeration": "未读内容",
  "dashboard.unreadModerationAttention": "建议尽快查看，避免遗漏",
  "dashboard.unreadModerationClear": "当前暂无未读内容",
  ...
  "dashboard.visitorsFilterBots": "过滤机器人",
  ...
  "dashboard.visitorsColumnDevice": "设备",
  "dashboard.visitorsColumnDuration": "加载耗时",
  "dashboard.visitorsColumnStatus": "结果",
  "dashboard.visitorsUnknown": "未知",
  "dashboard.visitorsBotTag": "机器人",
  "dashboard.visitorsDeviceTitle": "设备分布",
  "dashboard.visitorsBrowserTitle": "浏览器分布",
  "dashboard.visitorsReferrerTitle": "来源域名",
  "dashboard.visitorsBreakdownEmpty": "暂无数据",
  "dashboard.visitorsDevice.desktop": "桌面端",
  "dashboard.visitorsDevice.mobile": "移动端",
  "dashboard.visitorsDevice.tablet": "平板",
  "dashboard.visitorsDevice.bot": "机器人",
  "dashboard.visitorsDevice.unknown": "未知",
  "dashboard.visitorsDetailDevice": "设备类型",
  "dashboard.visitorsDetailBrowser": "浏览器",
  "dashboard.visitorsDetailOs": "操作系统",
  "dashboard.visitorsDetailScreen": "屏幕",
  "dashboard.visitorsDetailLanguage": "语言",
  "dashboard.visitorsDetailLocation": "归属地",
  "dashboard.visitorsDetailOwner": "归属机构",
  ...
  "dashboard.greetingNight": "夜深了",
  "dashboard.welcomeSubtitle": "欢迎回来 ･◡･",
  "dashboard.diagnosticsHealthy": "检查一切正常",
  "dashboard.diagnosticsAttention": "处理问题",
  "dashboard.diagnosticsRunning": "正在检查",
  "dashboard.diagnosticsUnknown": "尚未检查",

  // diagnostics
  "diagnostics.title": "系统诊断",
  "diagnostics.latestCheck": "最新诊断：{time}",
  "diagnostics.latestUnavailable": "暂不可用",
  "diagnostics.runNow": "立即检查",
  "diagnostics.checking": "检查中…",
  "diagnostics.neverRun": "尚未检查",
  "diagnostics.loadFailed": "暂时无法读取诊断结果，请稍后刷新重试。",
  "diagnostics.runFailed": "无法启动检查，请稍后重试。",
  "diagnostics.reload": "重新加载",
  "diagnostics.noResults": "完成一次检查后，这里会显示每个模块的结果。",
  "diagnostics.goFix": "前往处理",
  "diagnostics.goFixLabel": "前往处理：{item}",
  "diagnostics.openConfig": "查看配置",
  "diagnostics.openConfigLabel": "查看配置：{item}",
  "diagnostics.systemGuide.database": "数据库连接需要在部署环境中处理，请检查数据库服务、连接配置和后端日志。",
  "diagnostics.systemGuide.storage": "存储问题需要在部署环境中处理，请检查挂载目录、写入权限和磁盘可用空间。",
  "diagnostics.systemGuide.runner": "诊断任务异常需要检查后端运行日志；请先重新检查，若再次发生再排查运行环境。",
  "diagnostics.systemGuide.default": "这项问题需要在部署环境中处理，请结合上方详情检查服务配置与后端日志。",
  "diagnostics.duration": "耗时 {duration} ms",
  "diagnostics.check.database": "数据库",
  "diagnostics.check.storage": "本地存储",
  "diagnostics.check.modelApi": "模型服务",
  "diagnostics.check.smtp": "邮箱配置",
  "diagnostics.check.objectStorage": "对象存储 OSS",
  "diagnostics.check.proxy": "出站代理",
  "diagnostics.check.backup": "远程备份",
  "diagnostics.check.mcp": "MCP 服务",
  "diagnostics.check.serviceForwards": "服务转发",
  "diagnostics.check.runner": "诊断任务",
  "diagnostics.result.databaseHealthy": "数据库连接正常",
  "diagnostics.result.storageDirectoryUnavailable": "持久化目录不可用",
  "diagnostics.result.storageDirectoryMissingDetail": "目录不存在或不是文件夹：{path}",
  "diagnostics.result.storageDirectoryUnwritable": "持久化目录不可写",
  "diagnostics.result.storageUsageUnavailable": "无法读取持久化存储空间",
  "diagnostics.result.storageLow": "持久化存储空间偏低",
  "diagnostics.result.storageHealthy": "持久化目录可写，磁盘空间正常",
  "diagnostics.result.storageUsageDetail": "可用空间 / 总空间：{usage}",
  "diagnostics.result.modelDisabled": "模型来源未启用",
  "diagnostics.result.modelIncomplete": "模型来源配置不完整",
  "diagnostics.result.modelIncompleteDetail": "请完成 ChatGPT 登录，或填写兼容 API 的 Base URL、模型名称和 API Key。",
  "diagnostics.result.modelProbeFailed": "模型来源无法完成最小响应检查",
  "diagnostics.result.modelDegraded": "一个模型来源不可用，自动容灾仍可工作",
  "diagnostics.result.modelHealthy": "已启用的模型来源均响应正常",
  "diagnostics.result.modelNameDetail": "模型：{model}",
  "diagnostics.result.smtpDisabled": "邮件能力未启用",
  "diagnostics.result.smtpChanged": "邮箱配置在检查期间已更新",
  "diagnostics.result.smtpChangedDetail": "旧配置的检查结果已丢弃，请重新运行一次诊断。",
  "diagnostics.result.smtpFailed": "SMTP 测试邮件发送失败",
  "diagnostics.result.smtpHealthy": "SMTP 测试邮件成功发送",
  "diagnostics.result.objectStorageDisabled": "对象存储未启用",
  "diagnostics.result.objectStorageIncomplete": "对象存储配置不完整",
  "diagnostics.result.objectStorageIncompleteDetail": "请检查 Endpoint、Bucket、Access Key 和 Secret Key。",
  "diagnostics.result.objectStorageInitFailed": "对象存储配置无法初始化",
  "diagnostics.result.objectStorageUnavailable": "对象存储 Bucket 无法访问",
  "diagnostics.result.objectStorageSyncFailures": "有 {count} 个对象存储同步任务重试失败",
  "diagnostics.result.objectStorageSyncRetrying": "有 {count} 个对象存储同步任务正在重试",
  "diagnostics.result.objectStorageHealthy": "对象存储 Bucket 访问正常",
  "diagnostics.result.proxyNotConfigured": "出站代理未配置",
  "diagnostics.result.proxyPortMissing": "出站代理缺少端口配置",
  "diagnostics.result.proxyHealthy": "出站代理转发正常",
  "diagnostics.result.proxyFailed": "出站代理无法完成 HTTPS 请求",
  "diagnostics.result.backupDisabled": "远程备份未启用",
  "diagnostics.result.backupPaused": "远程备份已暂停",
  "diagnostics.result.backupProbeFailed": "备份配置无法完成连接检查",
  "diagnostics.result.backupUnavailable": "备份机无法连接",
  "diagnostics.result.backupForeignHistory": "备份机上存在另一套站点历史",
  "diagnostics.result.backupRecoveryKeyMissing": "备份恢复密钥尚未准备完成",
  "diagnostics.result.backupRecoveryKeyMissingDetail": "请生成、保存并确认恢复密钥后再启用自动备份。",
  "diagnostics.result.backupWriteUnavailable": "备份机远端目录无法写入",
  "diagnostics.result.backupLastError": "最近一次备份任务发生错误",
  "diagnostics.result.backupRetrying": "备份任务正在自动重试",
  "diagnostics.result.backupTaskFailed": "最近一次备份任务已耗尽重试次数",
  "diagnostics.result.backupStale": "最近成功备份已经超过预期时间",
  "diagnostics.result.backupStaleDetail": "连接和写入检查正常，可以前往备份记录确认任务调度。",
  "diagnostics.result.backupHealthy": "备份机连接正常，最近备份时间符合预期",
  "diagnostics.result.mcpDisabled": "MCP 服务未启用",
  "diagnostics.result.mcpRegistryEmpty": "MCP 能力注册表为空",
  "diagnostics.result.mcpConnectKeyMissing": "MCP 缺少启用且具有连接权限的 API Key",
  "diagnostics.result.mcpCapabilityMissing": "MCP API Key 没有可用的能力权限",
  "diagnostics.result.mcpHealthy": "MCP 配置与能力权限已就绪",
  "diagnostics.result.mcpCapabilityCountDetail": "当前至少有 {count} 项能力可用。",
  "diagnostics.result.serviceForwardsDisabled": "未配置服务转发",
  "diagnostics.result.serviceForwardsHealthy": "{count} 个服务转发均可访问",
  "diagnostics.result.serviceForwardsDegraded": "有 {count} 个服务转发不可访问",
  "diagnostics.result.serviceForwardsUnavailable": "全部 {count} 个服务转发均不可访问",
  "diagnostics.result.checkUnexpected": "检查过程中出现异常",
  "diagnostics.result.checkUnexpectedDetail": "请打开对应设置核对配置后重试。",
  "diagnostics.result.runnerAbandoned": "上一次诊断任务未能完成",
  "diagnostics.result.runnerAbandonedDetail": "任务运行超过 10 分钟后已停止等待，请重新检查；若再次发生，请查看系统日志。",
  "diagnostics.result.runnerFailed": "诊断任务未能完成",
  "diagnostics.result.runnerFailedDetail": "请稍后重试；如果问题持续存在，请检查系统日志与运行环境。",
  "dashboard.overviewContent": "内容概览",
  "dashboard.overviewTraffic": "站点流量",
  "dashboard.viewMonitoring": "查看访客监控",
  "dashboard.statComments": "评论",
  "dashboard.statGuestbook": "留言",
  ...
  "editor.edit": "编辑",
  "editor.mobileTitle": "正文编辑",
  "editor.mobileOpen": "全屏书写",
  "editor.mobileEmpty": "正文还没开始",
  "editor.mobileCharacterCount": "{count} 字",
  "editor.mobilePlaceholder": "开始写正文...",
  "editor.mobilePreview": "预览",
  "editor.mobileEdit": "继续写",
  "editor.mobileToolbarOpen": "展开工具栏",
  "editor.mobileToolbarClose": "收起工具栏",
  ...
  "siteConfig.contentSubscriptionPlaceholderHelpFeedUrl":
    "{feed_url}：站点 RSS 链接",
  "siteConfig.mailTemplateRestoreDefault": "恢复默认",
  "siteConfig.contentSubscriptionAdvancedSave": "保存订阅配置",
  "siteConfig.contentSubscriptionAvailable": "邮箱订阅可用",
  "siteConfig.contentSubscriptionUnavailable": "邮箱订阅不可用（请先完成试发）",
  ...
  "more.sectionDescriptions.apiConfig": "ChatGPT 套餐与兼容 API 主备配置",
  ...
  "siteConfig.music.title": "背景音乐",
  "siteConfig.music.description": "管理前台可播放的背景音乐。",
  "siteConfig.music.enable": "开启背景音乐",
  "siteConfig.music.enableDescription": "开启后，前台会显示音乐播放控件；音乐仍需访客主动播放。",
  "siteConfig.music.enableEmpty": "暂无可用曲目，上传并启用至少一首后才能开启。",
  "siteConfig.music.playbackMode": "播放模式",
  "siteConfig.music.sequential": "顺序播放",
  "siteConfig.music.random": "随机播放",
  "siteConfig.music.upload": "上传音乐",
  "siteConfig.music.uploading": "上传中…",
  "siteConfig.music.chooseFile": "选择音乐文件",
  "siteConfig.music.uploadSuccess": "音乐上传成功",
  "siteConfig.music.cleanupFailed": "曲目创建失败，上传资源未能自动清理，请到资源页检查",
  "siteConfig.music.cacheHint": "音乐使用不可变资源地址并支持 HTTP Range；配置 CDN 后会长期缓存音频字节，歌单变化仍通过 ETag 及时重新验证。",
  "siteConfig.music.playlist": "音乐列表",
  "siteConfig.music.empty": "暂无音乐，上传第一首歌曲后即可开启。",
  "siteConfig.music.previewPlay": "试听{title}",
  "siteConfig.music.previewPause": "暂停试听{title}",
  "siteConfig.music.preview": "试听",
  "siteConfig.music.pausePreview": "暂停",
  "siteConfig.music.previewFailed": "音乐试听失败",
  "siteConfig.music.titleInput": "{title}的歌名",
  "siteConfig.music.saveTitle": "保存{title}的歌名",
  "siteConfig.music.enableTrack": "启用{title}",
  "siteConfig.music.moveUp": "上移{title}",
  "siteConfig.music.moveDown": "下移{title}",
  "siteConfig.music.moveUpLabel": "上移",
  "siteConfig.music.moveDownLabel": "下移",
  "siteConfig.music.deleteTrack": "删除{title}",
  "siteConfig.music.deleteConfirmTitle": "删除这首音乐？",
  "siteConfig.music.deleteConfirmDescription": "将同时删除“{title}”及其音频资源，此操作无法撤销。",
