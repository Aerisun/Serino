...
class BackupTargetConfig(Base, TimestampMixin):
    ...
    max_retention_count: Mapped[int] = mapped_column(Integer(), nullable=False, default=80)
    retention_days: Mapped[int] = mapped_column(Integer(), nullable=False, default=60)
