...
export const frontendTranslations: Record<FrontendLang, Record<string, string>> = {
  zh: {
    ...
    "footer.poweredBy": "Powered by Aerisun /Serino",
    "footer.githubRepoAria": "前往 Serino GitHub 仓库",
    ...
    "waline.form.replyingTo": "正在回复 {name}",
  ...
  en: {
    ...
    "footer.poweredBy": "Powered by Aerisun /Serino",
    "footer.githubRepoAria": "Open Serino GitHub repository",
    ...
    "waline.form.replyingTo": "Replying to {name}",
