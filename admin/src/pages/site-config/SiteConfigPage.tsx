...
const LOGIN_MODE_OPTIONS = ["disable", "enable", "force"] as const;
const AVATAR_STRATEGY_OPTIONS = ["identicon", "gravatar", "library"] as const;
const MIGRATION_STATE_OPTIONS = ["draft", "syncing", "ready", "done"] as const;
