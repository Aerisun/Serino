"""Add the post detail approval flag.

Revision ID: 0017_post_requires_approval
Revises: 0016_post_rss_exclusion
...
revision = "0017_post_requires_approval"
down_revision = "0016_post_rss_exclusion"
branch_labels = None
depends_on = None
