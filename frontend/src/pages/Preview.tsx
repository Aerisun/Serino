...
function PostPreview({ data }: { data: PreviewData }) {
  ...
  return (
    <>
      ...
      {featureFlags.toc && (
        <TableOfContents containerRef={articleRef} content={[data.body]} />
      )}
...
export default function Preview() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Preview banner */}
      <div className="fixed top-0 left-0 right-0 z-[9999] flex items-center justify-center bg-amber-500/90 px-4 py-1 text-xs font-medium text-white backdrop-blur-sm">
        预览模式 — 此内容尚未发布
      </div>
