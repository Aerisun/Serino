...
export const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "settings.passwordChangeRequiredTitle": "首次登录需要先修改管理员密码",
    "settings.passwordChangeRequiredDesc": "当前后台处于首次登录安全模式。完成改密前，其他后台功能会保持锁定。",
    "settings.passwordChangeRequiredHint": "请使用当前临时密码完成一次改密。修改成功后，当前会话会立即解锁，其它旧会话会被自动注销。",
  ...
  en: {
    ...
    "settings.passwordChangeRequiredTitle": "Change the admin password before using the console",
    "settings.passwordChangeRequiredDesc": "The admin console is in first-login security mode. Other admin features stay locked until the password is updated.",
    "settings.passwordChangeRequiredHint": "Use the temporary password one last time to set a new one. After a successful change, this session is unlocked immediately and other old sessions are revoked.",
