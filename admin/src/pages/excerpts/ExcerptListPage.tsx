...
import { listExcerpts, createExcerpt, updateExcerpt, deleteExcerpt, bulkDeleteExcerpts, bulkStatusExcerpts } from "@/api/endpoints/excerpts";
  ...
  const { items, total, pageSize, isLoading, bulkDelete, bulkStatus, isBulkDeleting } = useResourceList(
    {
      queryKey: "excerpts",
      listFn: listExcerpts,
      createFn: createExcerpt,
      updateFn: updateExcerpt,
      deleteFn: deleteExcerpt,
      bulkDeleteFn: bulkDeleteExcerpts,
      bulkStatusFn: bulkStatusExcerpts,
    },
