...
export const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "siteConfig.poemSourceHitokotoDesc": "从 hitokoto 获取文案。",
    ...
    "siteConfig.commentAnonymousEnabledDesc": "访客无需登录也能发表评论",
    ...
    "dashboard.visitorsRecordsDescription": "展示最近 10 条访问记录，显示完整 IP、归属地和结果描述。",
    ...
    "dashboard.visitorsEmptyDescription": "站点产生公共页面访问后，会在这里显示趋势。",
  ...
  en: {
    ...
    "siteConfig.poemSourceHitokotoDesc": "Fetch copy from Hitokoto.",
    ...
    "siteConfig.commentAnonymousEnabledDesc":
      "Visitors can comment without signing in",
    ...
    "assets.note": "Note",
    "assets.noteHint": "For description only; it does not affect the path or category.",
