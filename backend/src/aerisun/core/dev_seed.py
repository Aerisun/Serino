...
DEFAULT_PAGE_COPIES = [
    ...
    },
    {
        ...
        "extras": {
            ...
            "detailMissingTitle": "文稿不存在",
            "detailMissingDescription": "你访问的文稿暂时不存在。",
            "detailEndLabel": "— 完 —",
        },
    },
    {
...
DEFAULT_NAV_ITEMS = [
    ...
    {"label": "文稿", "href": "/posts", "page_key": "posts", "trigger": "none", "order_index": 1},
    {"label": "手记", "href": "/notes", "page_key": "notes", "trigger": "none", "order_index": 2},
    {"label": "友链", "href": "/friends", "page_key": "friends", "trigger": "none", "order_index": 3},
    {"label": "更多", "href": None, "page_key": "more", "trigger": "hover", "order_index": 4},
    {
        "label": "碎碎念",
        "href": "/thoughts",
        "page_key": "thoughts",
...
DEFAULT_COMMENT_AVATAR_PRESETS = [
    {
        "key": "shiro",
        "label": "Shiro",
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Shiro",
        "note": "社区默认头像预设：Shiro（seed 初始化）",
    },
    {
        "key": "glass",
        "label": "Glass",
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Glass",
        "note": "社区默认头像预设：Glass（seed 初始化）",
    },
    {
        "key": "aurora",
        "label": "Aurora",
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Aurora",
        "note": "社区默认头像预设：Aurora（seed 初始化）",
    },
    {
        "key": "paper",
        "label": "Paper",
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Paper",
        "note": "社区默认头像预设：Paper（seed 初始化）",
    },
    {
        "key": "dawn",
        "label": "Dawn",
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Dawn",
        "note": "社区默认头像预设：Dawn（seed 初始化）",
    },
    {
        "key": "pebble",
        "label": "Pebble",
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Pebble",
        "note": "社区默认头像预设：Pebble（seed 初始化）",
    },
    {
        "key": "amber",
        "label": "Amber",
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Amber",
        "note": "社区默认头像预设：Amber（seed 初始化）",
    },
    {
        "key": "mint",
        "label": "Mint",
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Mint",
        "note": "社区默认头像预设：Mint（seed 初始化）",
    },
    {
        "key": "cinder",
        "label": "Cinder",
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Cinder",
        "note": "社区默认头像预设：Cinder（seed 初始化）",
    },
    {
        "key": "tide",
        "label": "Tide",
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Tide",
        "note": "社区默认头像预设：Tide（seed 初始化）",
    },
    {
        "key": "plum",
        "label": "Plum",
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Plum",
        "note": "社区默认头像预设：Plum（seed 初始化）",
    },
    {
        "key": "linen",
        "label": "Linen",
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Linen",
...
DEFAULT_FRIENDS = [
    {
        ...
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Miku",
    ...
    },
    {
        ...
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Akara",
    ...
    },
    {
        ...
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Natsume",
    ...
    },
    {
        ...
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Paul",
    ...
    },
    {
        ...
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Nekoha",
    ...
    },
    {
        ...
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Erhecy",
    ...
    },
    {
        ...
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Qingya",
    ...
    },
    {
        ...
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=BaiYuan",
    ...
    },
    {
        ...
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=Lucifer",
    ...
    },
    {
        ...
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=QuietTerminal",
    ...
    },
    {
        ...
        "avatar_url": "/api/v1/avatars/10.x/notionists/svg?seed=SunsetArchive",
