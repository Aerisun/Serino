...
const PAGE_FIELDS: Record<string, PageFieldDefinition[]> = {
  ...
  notes: [
    ...
    WIDTH_FIELD,
    PAGE_SIZE_FIELD,
    extraField("errorTitle", "text", "手记页加载失败标题", "手记列表错误标题", "手记列表加载失败时显示。", ["手记列表错误标题", "手记详情错误标题"]),
    extraField("retryLabel", "text", "手记页重试按钮", "手记错误状态按钮文案", "用于手记列表和手记详情错误状态。", ["手记列表错误按钮", "手记详情错误按钮"]),
    extraField("loadMoreLabel", "text", "手记页加载更多文案", "手记列表加载更多提示", "手记列表继续加载时显示。", ["手记列表底部加载提示"]),
    extraField("category_all_label", "text", "手记分类「全部」标签", "手记分类筛选里的全部标签", "控制分类筛选的第一个选项名称。", ["手记分类筛选"]),
    extraField("category_fallback_label", "text", "手记分类缺省标签", "手记没有分类时的兜底名称", "用于没有分类的手记卡片和详情页。", ["手记分类兜底"]),
    extraField("detailBackLabel", "text", "手记详情返回按钮", "手记详情页顶部返回按钮", "控制手记详情页左上角返回按钮文案。", ["手记详情页顶部返回按钮"]),
    extraField("detailListLabel", "text", "手记详情「返回列表」按钮", "手记详情空状态按钮", "手记不存在时的返回列表按钮文案。", ["手记详情空状态按钮"]),
    extraField("detailMissingTitle", "text", "手记详情不存在标题", "手记详情空状态标题", "找不到手记时显示。", ["手记详情空状态标题"]),
    extraField("detailMissingDescription", "textarea", "手记详情不存在说明", "手记详情空状态说明", "找不到手记时的补充说明。", ["手记详情空状态说明"]),
    extraField("detailEndLabel", "text", "手记详情结尾文案", "手记正文结束后的短句", "显示在手记正文底部。", ["手记详情正文结尾"]),
  ],
  diary: [
    TITLE_FIELD,
    SUBTITLE_FIELD,
