...
export const enTranslations: TranslationDict = {
    ...
    "dashboard.updateQueued": "Checking updates",
    ...
    "dashboard.updateInterruptingTitle": "Service will pause briefly",
    "dashboard.updateInterruptingLine1": "The update is taking over the service",
    "dashboard.updateInterruptingLine2": "Trust me, take a breath and sip some tea. I'll be right back.",
    ...
    "assets.scopeArticle": "Article assets",
    "assets.scopeVisitor": "Visitor assets",
    "assets.scopeSystem": "System assets",
    "assets.scopeOssSync": "OSS sync records",
    "assets.scopeServiceForward": "Service forwarding",
    ...
    "assets.syncTypeLocalDelete": "Local delete",
    ...
    "assets.syncRetry": "Retry",
    "assets.syncRetryQueued": "Queued for retry",
    "assets.syncRetryFailed": "Could not queue this record for retry",
    "assets.syncLastError": "Latest error",
    "assets.links": "Links",
    ...
    // service forwards
    "serviceForwards.add": "Add",
    "serviceForwards.addTitle": "Add service forwarding",
    "serviceForwards.pageDescription": "Expose services on this machine or your Tailscale network through the current domain",
    "serviceForwards.editTitle": "Edit service forwarding",
    "serviceForwards.name": "Service name",
    "serviceForwards.namePlaceholder": "For example: Home dashboard",
    "serviceForwards.slug": "slug",
    "serviceForwards.publicPath": "Public path",
    "serviceForwards.target": "Target",
    "serviceForwards.source": "Source",
    "serviceForwards.source.local": "This machine",
    "serviceForwards.source.tailscale": "Tailscale",
    "serviceForwards.source.custom": "CLI rule",
    "serviceForwards.port": "Port",
    "serviceForwards.targetUrl": "Tailscale service URL",
    "serviceForwards.targetUrlPlaceholder": "https://device.tailnet.ts.net/service-path",
    "serviceForwards.status": "Status",
    "serviceForwards.reachable": "Reachable",
    "serviceForwards.unreachable": "Unreachable",
    "serviceForwards.unchecked": "Unchecked",
    "serviceForwards.open": "Open service",
    "serviceForwards.test": "Test connectivity",
    "serviceForwards.customEditHint": "Continue using sercli to edit CLI-created rules",
    "serviceForwards.create": "Create",
    "serviceForwards.created": "Service forwarding created",
    "serviceForwards.updated": "Service forwarding updated",
    "serviceForwards.deleted": "Service forwarding deleted",
    "serviceForwards.testReachable": "Service is reachable",
    "serviceForwards.testUnreachable": "Service is currently unreachable",
    "serviceForwards.testFailed": "Connectivity test failed",
    "serviceForwards.loadFailed": "Service forwarding could not be loaded. Check the service and try again.",
    "serviceForwards.reload": "Try again",
    "serviceForwards.requiredFields": "Enter a service name and slug",
    "serviceForwards.invalidPort": "Port must be between 1 and 65535",
    "serviceForwards.invalidTargetUrl": "Enter a complete Tailscale HTTP or HTTPS service URL",
    "serviceForwards.deleteTitle": "Delete service forwarding?",
    "serviceForwards.deleteDescription": "Deleting “{name}” immediately stops forwarding from its public path.",
    "serviceForwards.confirmDelete": "Delete",
    ...
    "integrations.mcpUsageGuides": "Usage guides",
    "integrations.mcpRestGuideTitle": "REST API setup",
    "integrations.mcpRestDialogDescription":
      "The shortest path for a manual remote MCP connection.",
    "integrations.mcpRestStepCreateKeyTitle": "Create and save an API key",
    "integrations.mcpRestStepCreateKeyDescription":
      "Select the permissions your agent needs in MCP Permissions, then create and save the full key string.",
    "integrations.mcpRestStepAgentTitle": "Give the key to your agent",
    "integrations.mcpRestStepAgentPrefix":
      "Send the key string to your agent and ask it to visit",
    "integrations.mcpRestStepAgentSuffix":
      "to read the usage guide and available capabilities.",
    "integrations.mcpRestStepReadyTitle": "Start managing your site",
    "integrations.mcpRestStepReadyDescription":
      "After reading the guide, the agent works within that key's permissions. Tell it what you want to do next.",
    "integrations.mcpClientGuideTitle": "Codex / Claude Code setup",
    "integrations.mcpClientDialogDescription":
      "Install MCP and Skills and manage the API key.",
    ...
    "integrations.mcpInstallCopyFailed": "Copy failed. Select and copy the command manually.",
    ...
    "automation.deadLettersDescription":
      "Review deliveries that exhausted their retries and replay them after recovery.",
    ...
    "dashboard.visitorsFilterBots": "Filter bots",
    ...
    "dashboard.diagnosticsHealthy": "All checks passed",
    "dashboard.diagnosticsAttention": "Resolve issues",
    "dashboard.diagnosticsRunning": "Checking",
    "dashboard.diagnosticsUnknown": "Not checked yet",

    // diagnostics
    "diagnostics.title": "System Diagnostics",
    "diagnostics.latestCheck": "Latest check: {time}",
    "diagnostics.latestUnavailable": "Unavailable",
    "diagnostics.runNow": "Check now",
    "diagnostics.checking": "Checking…",
    "diagnostics.neverRun": "Not checked yet",
    "diagnostics.loadFailed": "Diagnostic results could not be loaded. Refresh and try again.",
    "diagnostics.runFailed": "The check could not be started. Try again shortly.",
    "diagnostics.reload": "Reload",
    "diagnostics.noResults": "Run a check to see the result for every module.",
    "diagnostics.goFix": "Resolve",
    "diagnostics.goFixLabel": "Resolve: {item}",
    "diagnostics.openConfig": "Open settings",
    "diagnostics.openConfigLabel": "Open settings: {item}",
    "diagnostics.systemGuide.database": "Database connectivity must be resolved in the deployment environment. Check the database service, connection settings, and backend logs.",
    "diagnostics.systemGuide.storage": "Storage issues must be resolved in the deployment environment. Check mounted directories, write permissions, and available disk space.",
    "diagnostics.systemGuide.runner": "Inspect backend logs for the diagnostic task. Run the check again first, then investigate the runtime environment if it recurs.",
    "diagnostics.systemGuide.default": "This issue must be resolved in the deployment environment. Use the details above to inspect service configuration and backend logs.",
    "diagnostics.duration": "{duration} ms",
    "diagnostics.check.database": "Database",
    "diagnostics.check.storage": "Local storage",
    "diagnostics.check.modelApi": "Model providers",
    "diagnostics.check.smtp": "Email configuration",
    "diagnostics.check.objectStorage": "Object storage",
    "diagnostics.check.proxy": "Outbound proxy",
    "diagnostics.check.backup": "Remote backup",
    "diagnostics.check.mcp": "MCP service",
    "diagnostics.check.serviceForwards": "Service forwarding",
    "diagnostics.check.runner": "Diagnostic task",
    "diagnostics.result.databaseHealthy": "Database connection is healthy",
    "diagnostics.result.storageDirectoryUnavailable": "A persistent storage directory is unavailable",
    "diagnostics.result.storageDirectoryMissingDetail": "The path does not exist or is not a directory: {path}",
    "diagnostics.result.storageDirectoryUnwritable": "A persistent storage directory is not writable",
    "diagnostics.result.storageUsageUnavailable": "Persistent storage usage could not be read",
    "diagnostics.result.storageLow": "Persistent storage space is running low",
    "diagnostics.result.storageHealthy": "Persistent directories are writable and disk space is healthy",
    "diagnostics.result.storageUsageDetail": "Free / total space: {usage}",
    "diagnostics.result.modelDisabled": "No model source is enabled",
    "diagnostics.result.modelIncomplete": "A model source configuration is incomplete",
    "diagnostics.result.modelIncompleteDetail": "Complete ChatGPT sign-in or enter the compatible API Base URL, model name, and API key.",
    "diagnostics.result.modelProbeFailed": "The model sources could not complete a minimal response check",
    "diagnostics.result.modelDegraded": "One model source is unavailable; automatic failover is still available",
    "diagnostics.result.modelHealthy": "All enabled model sources responded successfully",
    "diagnostics.result.modelNameDetail": "Model: {model}",
    "diagnostics.result.smtpDisabled": "Email delivery is not enabled",
    "diagnostics.result.smtpChanged": "Email settings changed during the check",
    "diagnostics.result.smtpChangedDetail": "The result for the previous settings was discarded. Run diagnostics again.",
    "diagnostics.result.smtpFailed": "The SMTP test email could not be sent",
    "diagnostics.result.smtpHealthy": "The SMTP test email was sent successfully",
    "diagnostics.result.objectStorageDisabled": "Object storage is not enabled",
    "diagnostics.result.objectStorageIncomplete": "The object storage configuration is incomplete",
    "diagnostics.result.objectStorageIncompleteDetail": "Check the Endpoint, Bucket, Access Key, and Secret Key.",
    "diagnostics.result.objectStorageInitFailed": "Object storage could not be initialized",
    "diagnostics.result.objectStorageUnavailable": "The object storage bucket is not accessible",
    "diagnostics.result.objectStorageSyncFailures": "{count} object storage sync jobs exhausted their retries",
    "diagnostics.result.objectStorageSyncRetrying": "{count} object storage sync jobs are retrying",
    "diagnostics.result.objectStorageHealthy": "The object storage bucket is accessible",
    "diagnostics.result.proxyNotConfigured": "The outbound proxy is not configured",
    "diagnostics.result.proxyPortMissing": "The outbound proxy port is missing",
    "diagnostics.result.proxyHealthy": "Outbound proxy forwarding is healthy",
    "diagnostics.result.proxyFailed": "The outbound proxy could not complete an HTTPS request",
    "diagnostics.result.backupDisabled": "Remote backup is not enabled",
    "diagnostics.result.backupPaused": "Remote backup is paused",
    "diagnostics.result.backupProbeFailed": "The backup configuration could not complete its connection check",
    "diagnostics.result.backupUnavailable": "The backup machine is unreachable",
    "diagnostics.result.backupForeignHistory": "Backup history from another site exists on the backup machine",
    "diagnostics.result.backupRecoveryKeyMissing": "The backup recovery key is not ready",
    "diagnostics.result.backupRecoveryKeyMissingDetail": "Generate, save, and acknowledge the recovery key before enabling automatic backups.",
    "diagnostics.result.backupWriteUnavailable": "The remote backup directory is not writable",
    "diagnostics.result.backupLastError": "The latest backup job reported an error",
    "diagnostics.result.backupRetrying": "The backup job is retrying automatically",
    "diagnostics.result.backupTaskFailed": "The latest backup job exhausted its retries",
    "diagnostics.result.backupStale": "The latest successful backup is older than expected",
    "diagnostics.result.backupStaleDetail": "Connection and write checks passed. Open backup history to confirm job scheduling.",
    "diagnostics.result.backupHealthy": "The backup machine is reachable and the latest backup is on schedule",
    "diagnostics.result.mcpDisabled": "The MCP service is not enabled",
    "diagnostics.result.mcpRegistryEmpty": "The MCP capability registry is empty",
    "diagnostics.result.mcpConnectKeyMissing": "MCP has no enabled API key with connection permission",
    "diagnostics.result.mcpCapabilityMissing": "The MCP API key has no usable capability permissions",
    "diagnostics.result.mcpHealthy": "MCP configuration and capability permissions are ready",
    "diagnostics.result.mcpCapabilityCountDetail": "At least {count} capabilities are currently available.",
    "diagnostics.result.serviceForwardsDisabled": "No service forwarding is configured",
    "diagnostics.result.serviceForwardsHealthy": "All {count} service forwarding rules are reachable",
    "diagnostics.result.serviceForwardsDegraded": "{count} service forwarding rules are unreachable",
    "diagnostics.result.serviceForwardsUnavailable": "All {count} service forwarding rules are unreachable",
    "diagnostics.result.checkUnexpected": "An unexpected error occurred during this check",
    "diagnostics.result.checkUnexpectedDetail": "Review the related settings and run the check again.",
    "diagnostics.result.runnerAbandoned": "The previous diagnostic run did not finish",
    "diagnostics.result.runnerAbandonedDetail": "The run stopped waiting after 10 minutes. Run it again and inspect system logs if the issue recurs.",
    "diagnostics.result.runnerFailed": "The diagnostic run did not finish",
    "diagnostics.result.runnerFailedDetail": "Try again shortly. If the issue persists, inspect system logs and the runtime environment.",
    ...
    "more.tabs.apiConfig": "Model Config",
    ...
    "more.sectionDescriptions.apiConfig": "ChatGPT plan and compatible API failover settings",
    ...
    "siteConfig.music.title": "Background Music",
    "siteConfig.music.description": "Manage background music visitors can play on the site.",
    "siteConfig.music.enable": "Enable background music",
    "siteConfig.music.enableDescription": "Shows the music controls on the public site; visitors still start playback themselves.",
    "siteConfig.music.enableEmpty": "Upload and enable at least one playable track before turning this on.",
    "siteConfig.music.playbackMode": "Playback mode",
    "siteConfig.music.sequential": "Sequential",
    "siteConfig.music.random": "Shuffle",
    "siteConfig.music.upload": "Upload music",
    "siteConfig.music.uploading": "Uploading…",
    "siteConfig.music.chooseFile": "Choose music file",
    "siteConfig.music.uploadSuccess": "Music uploaded",
    "siteConfig.music.cleanupFailed": "Track creation failed and the uploaded asset could not be cleaned up. Check Assets.",
    "siteConfig.music.cacheHint": "Music uses immutable URLs and HTTP Range. With a CDN configured, audio bytes are cached long-term while playlist changes still revalidate through ETag.",
    "siteConfig.music.playlist": "Music playlist",
    "siteConfig.music.empty": "No music yet. Upload the first track to enable the player.",
    "siteConfig.music.previewPlay": "Preview {title}",
    "siteConfig.music.previewPause": "Pause preview of {title}",
    "siteConfig.music.preview": "Preview",
    "siteConfig.music.pausePreview": "Pause",
    "siteConfig.music.previewFailed": "Music preview failed",
    "siteConfig.music.titleInput": "Title for {title}",
    "siteConfig.music.saveTitle": "Save title for {title}",
    "siteConfig.music.enableTrack": "Enable {title}",
    "siteConfig.music.moveUp": "Move {title} up",
    "siteConfig.music.moveDown": "Move {title} down",
    "siteConfig.music.moveUpLabel": "Move up",
    "siteConfig.music.moveDownLabel": "Move down",
    "siteConfig.music.deleteTrack": "Delete {title}",
    "siteConfig.music.deleteConfirmTitle": "Delete this track?",
    "siteConfig.music.deleteConfirmDescription": "This also deletes “{title}” and its audio asset. This cannot be undone.",
