...
export AERISUN_WALINE_SERVER_URL="${AERISUN_PROCESS_BROWSER_WALINE_URL:-/waline}"

export WALINE_PORT="${AERISUN_PROCESS_WALINE_PORT}"
export WALINE_SERVER_URL="${AERISUN_PROCESS_WALINE_SERVER_URL:-http://localhost:${AERISUN_PROCESS_FRONTEND_PORT}/waline}"
