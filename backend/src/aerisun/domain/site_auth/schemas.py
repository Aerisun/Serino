...
class EmailLoginRequest(BaseModel):
    ...
    admin_password: str | None = Field(default=None, description="Admin console password when elevation is needed")
...
class EmailLoginResponse(BaseModel):
    ...
    requires_admin_password: bool = Field(
        default=False,
        description="Whether admin email login requires the admin console password before creating a session",
    )
